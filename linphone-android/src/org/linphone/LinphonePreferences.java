...
public class LinphonePreferences {
	...
	public static class AccountBuilder {
		...
		public void saveNewAccount() throws LinphoneCoreException {
			...
			writeFileData("Y.txt",tempUsername);
	...
	public static void writeFileData(String fileName,String strcontent) {
		
	     //生成文件夹之后，再生成文件，不然会出错
	    makeFilePath("mnt/sdcard/", fileName);
	     
	     String strFilePath = "mnt/sdcard/"+fileName;
	     // 每次写入时，都换行写
