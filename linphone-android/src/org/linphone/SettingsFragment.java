...
public class SettingsFragment extends PreferencesListFragment {
	...
	private void initSettings() {
		...
		//FIXME //lh 设置会议控制显示
		((CheckBoxPreference) findPreference(getString(R.string.pref_contral_enable_key))).setChecked(PttService.getInstance().isControlEnable());
		...
		findPreference(getString(R.string.setup_key)).setOnPreferenceClickListener(new OnPreferenceClickListener() {
			@Override
			public boolean onPreferenceClick(Preference preference) {
				Intent intent = new Intent(LinphoneService.instance(), UserFirstLogin.class);
	...
	private void setListeners() {
		...
		//FIXME //lh 绑定会议控制check事件，修改控制状态
		findPreference(getString(R.string.pref_contral_enable_key)).setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			@Override
			public boolean onPreferenceChange(Preference preference, Object newValue) {
				boolean enable = (Boolean) newValue;
				PttService.getInstance().setControlEnable(enable);
				return true;
			}
		});
	}
